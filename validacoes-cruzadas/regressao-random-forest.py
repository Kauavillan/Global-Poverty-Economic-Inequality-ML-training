...
for indice_treinamento, indice_teste in kfold.split(previsores_arr):
    ...
    regressor = RandomForestRegressor(n_estimators=150, max_features=10, max_depth=15, random_state=42)
    
    # Treinamento (ravel() para formato 1D exigido pelo target)
...
ax1.set_title("Gráfico de Resíduos (Random Forest)")
...
ax2.set_title("Distribuição do Desvio Relativo (Random Forest)")
