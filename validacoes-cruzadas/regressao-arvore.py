...
print("Iniciando treinamento (Árvore de Decisão)...")
...
for indice_treinamento, indice_teste in kfold.split(previsores_arr):
    ...
    # Treinamento (ravel() para formato 1D caso necessário)
...
ax1.set_title("Gráfico de Resíduos (Árvore de Decisão)")
...
ax2.set_title("Distribuição do Desvio Relativo (Árvore de Decisão)")
