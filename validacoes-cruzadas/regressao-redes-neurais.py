...
print("Iniciando treinamento (Redes Neurais)...")
...
ax1.set_title("Gráfico de Resíduos (Redes Neurais)")
...
plt.ylabel("Previsão")
plt.title("Previsões vs Valores Reais (Redes Neurais)")
plt.legend()
...
ax2.set_title("Distribuição do Desvio Relativo (Redes Neurais)")
